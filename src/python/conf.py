...
create_contributions_table_script_path = project_root_dir + '/src/hive/create_contributions_table.hql'
create_partitioned_contributions_table_script_path = project_root_dir + '/src/hive/create_partitioned_contributions_table.hql'
create_expenditures_table_script_path = project_root_dir + '/src/hive/create_expenditures_table.hql'
create_partitioned_expenditures_table_script_path = project_root_dir + '/src/hive/create_partitioned_expenditures_table.hql'
